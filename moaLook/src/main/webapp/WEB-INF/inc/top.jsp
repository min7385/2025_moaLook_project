...
<!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="${pageContext.request.contextPath}/">moaLook</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath }/boardView">내 옷장</a></li>
                        <li class="nav-item"><a class="nav-link" href="#!">둘러보기</a></li>
                    ...
                    <c:if test="${sessionScope.login != null}">
                    	<form class="d-flex">
							...
							<button type="button" class="btn btn-outline-dark" style="border: none;" onclick="location.href='<%=request.getContextPath()%>/logoutDo'">로그아웃</button>
                    	</form>
                    </c:if>
                </div>
            </div>
